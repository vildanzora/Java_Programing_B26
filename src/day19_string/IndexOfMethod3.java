...
public class IndexOfMethod3 {
    public static void main(String[] args) {
        ...
        System.out.println("third i: " + word.indexOf('i' , 6)); // finding i after the character of index number 6 which mean is 7 the third i's index number //  start from pos 6 --> tion";
